...
public abstract class Unit {
    ...
    protected Unit() {
		...
		TemplateClass.instrum(27, "Assign", "Unit.Unit().direction: ",this.direction.toString());
    }
    ...
    public void setDirection(Direction newDirection) {
		...
		TemplateClass.instrum(35, "Assign", "Unit.setDirection().direction: ",this.direction.toString(), "Unit.setDirection().newDirection: ",newDirection.toString());
    }
