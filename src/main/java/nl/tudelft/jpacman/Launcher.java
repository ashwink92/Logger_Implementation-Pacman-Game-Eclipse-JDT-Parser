...
public class Launcher {
    ...
    public Launcher withMapFile(String fileName) {
        levelMap = fileName;
		//TemplateClass.instrum(69, "Assign", "Launcher.withMapFile().levelMap: ",levelMap.toString(), "Launcher.withMapFile().fileName: ",fileName.toString());
        return this;
    }
    ...
    public Game makeGame() {
		...
		//TemplateClass.instrum(82, "Assign", "Launcher.makeGame().game: ",game.toString(), "Launcher.makeGame().gf: ",gf.toString(), "Launcher.makeGame().level: ",level.toString());
        return game;
    }
    ...
    protected void addSinglePlayerKeys(final PacManUiBuilder builder) {
		...
		//TemplateClass.instrum(160, "Assign", "Launcher.addSinglePlayerKeys().builder: ",builder.toString(), "Launcher.addSinglePlayerKeys().VK_UP: ", String.valueOf(KeyEvent.VK_UP), "Launcher.addSinglePlayerKeys().NORTH: ",Direction.NORTH.toString());
    }
    ...
    private Player getSinglePlayer(final Game game) {
        ...
        //TemplateClass.instrum(175, "IF Statement", "Launcher.getSinglePlayer().players: ",players.toString());
		if (players.isEmpty()) {
...
//		TemplateClass.instrum(188, "Assign", "Launcher.launch().builder: ",builder.toString());
        pacManUI = builder.build(getGame());
//        TemplateClass.printTrace();
//        TemplateClass.instrum(189, "Assign", "Launcher.launch().pacManUI: ",pacManUI.toString(), "Launcher.launch().builder: ",builder.toString());
//        TemplateClass.instrum(190, "Assign", "Launcher.launch().pacManUI: ",pacManUI.toString());
        TemplateClass.printTrace();
        //wait(5);
        pacManUI.start();
    }
     ...
     */
    public static void main(String[] args) throws IOException, BadLocationException, CoreException, InterruptedException {
        //GetFileNames.launchParser();
        new Launcher().launch();
        //TemplateClass.printTrace();
    }
}
